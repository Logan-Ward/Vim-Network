    ...
    <Breathe />
        <main className='container' style={{display: 'none'}}>
          ...
          <div className='mission-section' style={{opacity: 0}}>
            <p className='mission'>
              Vim Network’s mission is to empower families with children who have disabilities through meaningful connections and a diverse
              range of wellness resources
            </p>
          </div>
          ...
          <div className='description-section' style={{opacity: 0}}>
            <p className='description'>
              Vim Network is set to be an online space that not only taps into
              the power of community, but reminds its users that what we put
              energy towards shapes our reality.
            </p>
          </div>
          <div className='signup-section' style={{opacity: 0}}>
          <p className='signup'>If this intention resonates with you, sign up to hear more:</p>
